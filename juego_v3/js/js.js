...
{//Esta función evalua si la respuesta es correcta o incorrecta
	...
	if ( stop == 11 ) {
		...
		if (g_score=>6){
			document.getElementById("nivel").innerHTML= "<h2> You won the game con </h2>" + g_correctas; 
		}else{
			document.getElementById("nivel").innerHTML= "<h2>keep trying</h2>" + g_incorrectas;
		}
